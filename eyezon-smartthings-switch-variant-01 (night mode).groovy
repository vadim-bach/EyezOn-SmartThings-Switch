...
preferences {
    section("Settings"){
        ...
        input "mode", "enum", title: "Arm Mode", options: [ARM_MODE_STAY(), ARM_MODE_NIGHT(), ARM_MODE_AWAY()]
...
def off() {
    ...
    def systemStatus = getSystemStatus()
    if (![STATUS_AWAY_ARMED(), STATUS_STAY_ARMED(), STATUS_NIGHT_ARMED(), STATUS_EXIT_DELAY()].contains(systemStatus)) {
